...
<div class="box_containerlienhe" style=" margin-top:-14px;">
<div class="title-global"><h2><?=_contact_us_?></h2></div>
   <div class="content">
      ...
      <table width="100%" cellpadding="5" cellspacing="0" border="0" class="tablelienhe">
				 ...
				 <div class="row">
					 <ul class="list_map">
            	<li><b>Địa chỉ :</b><?=$result_hotline['diachi']?> - Điện thoại: <?=$result_hotline['dienthoai']?> <a onclick="moveToMaker(7895)" href="javascript:()"></a> </li>              
            </ul>
		   ...
		   var infowindow_array= new Array();function initialize(){
			   var defaultLatLng = new google.maps.LatLng(10.83375,106.68169);
			   var myOptions= {
				   zoom: 16,
			   ...
			   var arrLatLng = new google.maps.LatLng(10.83375,106.68169);
			   infoWindowArray[7895] = '<div class="map_description"><div class="map_title"><?=$result_hotline['ten']?></div><div>Địa Chỉ : <?=$result_hotline['diachi']?> - Điện thoại: <?=$result_hotline['dienthoai']?>  </div></div>';
