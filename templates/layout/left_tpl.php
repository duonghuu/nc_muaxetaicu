...
<section>
  <div class="box-left">
    ...
    <div class="content support">
      ...
      foreach($d->result_array() as $k=>$v){
        echo '<div class="sp-item"><div>'.$v['ten'].'&nbsp;&nbsp;<a href="skype:'.$v['skype'].'?chat" alt="Chat với tôi" style="margin-right:3px">
        <img src="assets/img/skype-mini.png" /></a><a href="ymsgr:sendIM?'.$v['yahoo'].'" title="Chat với tôi">
        <img src="assets/img/yahoo-mini.png" /></a></div>';
        echo '<div class="phone">Tel: <span>'.$v['dienthoai'].'</span></div>';
        echo '<div class="email">Email: '.$v['email'].'</div>';
        echo '</div>';
      }
      ?>
    </div>
