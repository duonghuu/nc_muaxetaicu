...
function send(){
	...
	if(isset($_POST['listid'])){
		...
		$mail->SMTPSecure = "ssl";
		$mail->Host       = "116.193.76.25";     // Thiết lập thông tin của SMPT
		$mail->Port       = 465;                     // Thiết lập cổng gửi email của máy
		$mail->Username   = "info@banhchunggac.com"; // SMTP account username
		$mail->Password   = "01267889@phuongit";            // SMTP account password
