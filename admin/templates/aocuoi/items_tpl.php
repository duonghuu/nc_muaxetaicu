...
<table class=" table table-bordered">
	...
	<tr>
       ...
       <td style="width:15%;" align="center">
        	<?php
			$sql_danhmuc="select ten_vi from table_".$_GET['com']."_danhmuc where id='".$items[$i]['id_danhmuc']."'";
		...
		<td style="width:15%;" align="center">
        	<?php
			$sql_danhmuc="select ten_vi from table_".$_GET['com']."_list where id='".$items[$i]['id_list']."'";
			$result=mysql_query($sql_danhmuc);
	 		$item_danhmuc =mysql_fetch_array($result);
	 		echo @$item_danhmuc['ten_vi'];
			?>  
