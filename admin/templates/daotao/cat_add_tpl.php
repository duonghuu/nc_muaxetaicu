...
<form name="frm" method="post" action="index.php?com=<?=$_GET['com']?>&act=save_cat" enctype="multipart/form-data" class="form-horizontal " role="form" > 
			 ...
			 <div class="checkbox">
			  ...
			  <div class="row">
				...
				<div class="form-group">
					<label for="inputEmail3" class="col-sm-2 align-left control-label">Số thứ tự</label>
					<div class="col-sm-8">
