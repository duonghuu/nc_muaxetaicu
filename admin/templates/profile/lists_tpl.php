...
<table class="table table-bordered">
	<thead>
		...
		<th style="width:35%;">Danh mục cấp 1</th>
	...
	<tr bgcolor="<?php if($i%2==1)echo '#F3F3F3' ?>">
		...
		<td align="center" style="width:40%;"><a href="index.php?com=<?=$_GET['com']?>&act=edit_list&id=<?=$items[$i]['id']?>"><?=$items[$i]['ten_vi']?></a> </td>
		 <td align="center">
        	<?php
			$sql_danhmuc="select ten_vi from table_profile_danhmuc where id='".$items[$i]['id_danhmuc']."'";
		...
		{
		?>
        <a href="index.php?com=<?=$_GET['com']?>&act=man_list&noibat=<?=$items[$i]['id']?>"><img src="media/images/active_1.png"  border="0"/></a>
		<?
		}
		else
		{
		?>
         <a href="index.php?com=<?=$_GET['com']?>&act=man_list&noibat=<?=$items[$i]['id']?>"><img src="media/images/active_0.png" border="0" /></a>
         <?php
		 }?>
